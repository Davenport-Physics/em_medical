...
CHECKED_BONES = {
	...
	SKEL_R_Calf     = {name = "SKEL_R_Calf", hash = 0x9000 },
	SKEL_R_Foot     = {name = "SKEL_R_Foot", hash = 0xCC4D },
	SKEL_R_Toe0     = {name = "SKEL_R_Toe0", hash = 0x512D },
	SKEL_L_Clavicle = {name = "SKEL_L_Clavicle", hash = 0xFCD9 },
	SKEL_L_UpperArm = {name = "SKEL_L_UpperArm", hash = 0xB1C5 },
	SKEL_L_Forearm  = {name = "SKEL_L_Forearm", hash = 0xEEEB },
    SKEL_L_Hand     = {name = "SKEL_L_Hand", hash = 0x49D9 },
    SKEL_R_Clavicle = {name = "SKEL_R_Clavicle", hash = 0x29D2 },
	SKEL_R_UpperArm = {name = "SKEL_R_UpperArm", hash = 0x9D4D },
	SKEL_R_Forearm  = {name = "SKEL_R_Forearm", hash = 0x6E5C },
    SKEL_R_Hand     = {name = "SKEL_R_Hand", hash = 0xDEAD },
    SKEL_Neck_1     = {name = "SKEL_Neck_1", hash = 0x9995 },
    SKEL_Head       = {name = "SKEL_Head", hash = 0x796E },
    SPR_L_Breast    = {name = "SPR_L_Breast", hash = 0xFC8E },
	SPR_R_Breast    = {name = "SPR_R_Breast", hash = 0x885F },
	SKEL_Spine0     = {name = "SKEL_Spine0", hash = 0x5C01},
	SKEL_Spine1     = {name = "SKEL_Spine1", hash = 0x60F0},
	SKEL_Spine2     = {name = "SKEL_Spine2", hash = 0x60F1},
	SKEL_Spine3     = {name = "SKEL_Spine3", hash = 0x60F2},
}
...
EFFECTS = {
	...
	ADRENALINE      = {name = "Adrenaline"   , modifiers = {stimulant = 2}, effect_time = 60, end_to = "No Adrenaline"},
